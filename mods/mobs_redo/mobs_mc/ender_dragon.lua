...
mobs:register_arrow(":mobs_mc:fireball2", {
	...
	hit_player = function(self, player)
		minetest.sound_play("tnt_explode", {pos = player:getpos(), gain = 1.5, max_hear_distance = 2*64}, true)
	...
	hit_mob = function(self, mob)
		minetest.sound_play("tnt_explode", {pos = mob:getpos(), gain = 1.5, max_hear_distance = 2*64}, true)
